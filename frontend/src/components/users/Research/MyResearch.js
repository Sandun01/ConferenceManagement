                            ...
                            <Table className={classes.table} aria-label="customized table" size="medium" >
                                <TableHead>
                                    <TableRow className={classes.tableHeaderRow}>
                                        ...
                                        <TableCell className={classes.tableHeader} align="center">Completed</TableCell>
...
export default withStyles(styles)(MyResearch);